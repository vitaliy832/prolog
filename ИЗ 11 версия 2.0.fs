...
let Edit1 = new TextBox(Text="1345121")
let Edit2 = new TextBox(Top=20, Text="3") 
...
let button5 = new Button(Text="я пришел сюда разделить на 0", Top=50, Left=120, Width=200, Height=25)
...
let  Dot _ =   MessageBox.Show(string(float(Edit1.Text)/   (float(0))), "Полиция уже едет к вам, оставайтесь на месте!") |>ignore
